...
init -1 python hide:
    ...
    config.name = "HummingBird VN 3.33"
...
python early:
    config.save_directory = "HummingBird VN 3.33-1429704267"
...
init python:
    ...
    build.directory_name = "Hummingbird-VN-3.33-0.0.1"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "Hummingbird-VN-3.33-0.0.1"
